...
const ONBOARDING_SLIDES = [
    {
        id: 'slide-1',
        tag: 'OMNICHANNEL MESSAGING',
        title: 'Welcome to Devlomatix',
        subtitle:
            'Power your customer conversations, automated flows, campaigns, and team collaboration in one unified platform.',
    ...
    },
    {
        ...
        title: 'Smart Chatbots & Flow Automation',
        subtitle:
            'Automate customer interactions, trigger marketing sequences, and streamline support effortlessly.',
    ...
    },
    {
        ...
        title: 'Kanban, Commerce & Analytics',
        subtitle:
            'Track tasks with Kanban boards, manage commerce orders, and monitor real-time growth analytics.',
