...
export default function KonnectXTabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false }} tabBar={(props) => <KonnectXTabBar {...props} />}>
...
function KonnectXTabBar({ state, descriptors, navigation }) {
  ...
  const icon = (routeName, iconColor) => {
    ...
    switch (routeName) {
      case 'index':
        return <Ionicons size={size} name="rocket-outline" color={iconColor} />;
      case 'chats':
