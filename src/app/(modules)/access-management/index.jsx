...
const FALLBACK_DATA = {
  ...
  roles: [
    { id: '1', title: 'Super Admin', description: 'Full system access with all permissions.', color: '#0d9488', permissionCount: 24, userCount: 1, permissions: ['Dashboard', 'Users', 'Roles', 'Permissions', 'KrishiMitra', 'Orders'] },
    { id: '2', title: 'Admin', description: 'Administrative access to manage workspace.', color: '#0284c7', permissionCount: 18, userCount: 1, permissions: ['Dashboard', 'Users', 'Roles', 'Permissions', 'KrishiMitra'] },
    { id: '3', title: 'Manager', description: 'Can manage content and field reports.', color: '#7c3aed', permissionCount: 12, userCount: 2, permissions: ['Dashboard', 'Users', 'KrishiMitra'] },
    { id: '4', title: 'Field Officer', description: 'Can diagnose crops and apply remedies.', color: '#16a34a', permissionCount: 8, userCount: 2, permissions: ['Dashboard', 'KrishiMitra'] },
    { id: '5', title: 'Viewer', description: 'Read-only access to agricultural dashboard.', color: '#d97706', permissionCount: 4, userCount: 1, permissions: ['Dashboard'] },
  ],
  permissions: [
    ...
    { id: 'perm-krishimitra', module: 'KrishiMitra', category: 'krishimitra', color: '#10b981', actions: { view: true, create: true, edit: true, delete: true, manage: true } },
    { id: 'perm-orders', module: 'Orders', category: 'orders', color: '#059669', actions: { view: true, create: true, edit: true, delete: false, manage: false } },
  ],
