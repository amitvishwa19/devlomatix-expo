...
export default function CrystalAuraEmptyState({ icon = 'cube-outline', title, description, ctaLabel, onCtaPress }) {
  ...
  return (
    <View className="items-center px-8 py-16">
      ...
      {ctaLabel && onCtaPress ? (
        <Pressable onPress={onCtaPress} className="mt-6 rounded-full bg-purple-600 px-6 py-3">
